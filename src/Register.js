import * as React from 'react';cd
import TextField from '@mui/material/TextField';
import Button from '@mui/material/Button';
import Styles from './components/mod.module.css';
  ...
  return (
    <div className={Styles.box}>
     <center><h1>Register</h1></center>
      ...
      <TextField id="filled-basic" label="Middlename" variant="filled"/>
